...
{{--                                @can('permission_edit')--}}
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.customers.edit', $permission->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
{{--                                @endcan--}}

{{--                                @can('permission_delete')--}}
                                    <form action="{{ route('admin.customers.destroy', $permission->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
