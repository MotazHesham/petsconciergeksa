...
@section('content')
    ...
    <div class="card" @if(app()->getLocale() == 'ar') style="    text-align: right; direction: rtl;" @endif>
        <div class="card-header">
            ...
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#return_invoice">مرتجع</button>
        ...
        <div class="card-body" id="cv">
            ...
            ?>
            <div class="raw" style="    text-align: right; direction: rtl;">
                    <img src="{{ asset('images/logo.png') }}" style="float: left; width: 272px;"/>
            </div>
             <div class="modal fade" id="return_invoice" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body custom_scroll">
                            <form method="POST" action="{{ route("admin.return.invoice") }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    
                                    <div class="form-group col-md-6">
                                        <input name="invoice_id" required type="hidden" class="form-control" value="{{$invoice->id}}">
                                        <label class="required" for="title">{{ trans('cruds.returnedInvoice.returned_invoice_number') }}</label>
                                        <input name="returned_invoice_number" required type="text" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="required" for="title">{{ trans('cruds.returnedInvoice.returned_invoice_date') }}</label>
                                        <input name="date_of_returned" required type="date" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <button type="button" class="btn btn-primary repeater-add-btn" data-dismiss="modal">
                                        {{ trans('global.close_modal') }}
                                    </button>
...
"  for="title">{{__('cruds.clients.fields.address', [], 'ar')}}
            ...
            <center><h6 style="    direction: rtl; margin-top: 105px;"> رقم الفاتورة: {{$invoice->num}} </h6></center>
            <div  style="text-align: left; direction: ltr;
" >
